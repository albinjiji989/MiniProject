...
function buildDefaultScopes() {
  ...
  const candidates = [
    ...
    { model: safeRequire('../modules/petshop/models/PetShop'), fields: ['storeId', 'storeCode'] },
    { model: safeRequire('../modules/adoption/models/AdoptionCenter'), fields: ['storeId', 'storeCode'] },
    { model: safeRequire('../modules/veterinary/models/VeterinaryClinic'), fields: ['storeId', 'storeCode'] },
    ...
    { model: safeRequire('../modules/temporary-care/models/TemporaryCareCenter'), fields: ['storeId', 'storeCode'] },
  ]
