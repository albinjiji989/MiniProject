...
inventoryItemSchema.virtual('images', {
  ref: 'Image',
  localField: 'imageIds',
  foreignField: '_id',
  justOne: false
...
inventoryItemSchema.methods.addImage = async function(imageData) {
...
inventoryItemSchema.methods.removeImage = async function(imageId) {
  const Image = mongoose.model('Image');
