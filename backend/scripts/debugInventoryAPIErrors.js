/**
 * Debug script to simulate the exact API calls that are failing
 */
...
const debugInventoryAPIErrors = async () => {
  try {
    await connectDB();
    
    console.log('🔍 Debugging inventory API errors...');
...
if (require.main === module) {
  debugInventoryAPIErrors();
}

module.exports = { debugInventoryAPIErrors };