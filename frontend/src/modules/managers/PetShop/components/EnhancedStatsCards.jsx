...
const EnhancedStatsCards = ({ 
  ...
  return (
    <Grid container spacing={2} sx={{ mb: 3 }}>
      ...
      {/* Pending Images Card */}
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ bgcolor: '#fff3e0', borderLeft: '4px solid #f57c00', height: '100%' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Box>
                <Typography variant="h4" fontWeight="bold">
      ...
      {/* Released Pets Card */}
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ bgcolor: '#e1f5fe', borderLeft: '4px solid #0288d1', height: '100%' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Box>
                <Typography variant="h4" fontWeight="bold">
      ...
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ bgcolor: '#f3e5f5', borderLeft: '4px solid #7b1fa2', height: '100%' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Box>
                <Typography variant="h4" fontWeight="bold">
      ...
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ bgcolor: '#fce4ec', borderLeft: '4px solid #e91e63', height: '100%' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Box>
                <Typography variant="h4" fontWeight="bold">
