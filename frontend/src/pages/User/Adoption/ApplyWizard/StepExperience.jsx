...
export default function StepExperience() {
  ...
  const [form, setForm] = useState(() => {
    try { return JSON.parse(localStorage.getItem(KEY))?.experience || { adoptionReason:'', expectations:'', petExperience:'none', previousPets:'' } } catch { return { adoptionReason:'', expectations:'', petExperience:'none', previousPets:'' } }
  })
