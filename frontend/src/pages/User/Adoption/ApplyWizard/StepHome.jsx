...
export default function StepHome() {
  ...
  const [form, setForm] = useState(() => {
    try { return JSON.parse(localStorage.getItem(KEY))?.home || { address:{street:'',city:'',state:'',pincode:'',country:''}, homeType:'apartment', hasGarden:false, hasOtherPets:false, otherPetsDetails:'', workSchedule:'full_time', timeAtHome:'4_8_hours' } } catch { return { address:{}, homeType:'apartment', workSchedule:'full_time', timeAtHome:'4_8_hours' } }
  })
