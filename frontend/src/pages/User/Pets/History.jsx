    ...
    try {
      ...
      if (petType === 'user') {
        ...
        try {
          ...
          throw new Error('History not found for user pet')
        }
      } else {
        ...
        try {
          ...
          const historyData = {
            ...
            ownershipHistory: res.data?.data?.history?.filter(record => record.eventType === 'ownership_transferred') || []
          };
          ...
          try {
            ...
            throw new Error('History not found in any system')
          }
        }
      }
    } catch (e) {
